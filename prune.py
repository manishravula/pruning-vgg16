...
def prune_vgg16_conv_layer(model, layer_index, filter_index, device):
    ...
    if not next_conv is None:
        ...
        new_linear_layer = \
            torch.nn.Linear(int(old_linear_layer.in_features - params_per_input_channel), int(old_linear_layer.out_features))
